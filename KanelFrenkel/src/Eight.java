...
public class Eight {
    ...
    public static void EightOneOne() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter the number of students");
        int countStudents = scanner.nextInt();
        System.out.println("Enter the number of chairs");
        int countChairs = scanner.nextInt();
        scanner.close();
        if ((countStudents - countChairs) != 0) {
            System.out.println((countStudents < countChairs) ? "Extra chairs = " + (countChairs - countStudents) :
                    "A shortage of chairs = " + (countStudents - countChairs));
        }
        if ((countStudents - countChairs) == 0) {
            System.out.println("All students had enough chairs and no extra ones left");
        }
     ...
     */
    public static void EightOneTwo() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter student grade");
        int studentGrade = scanner.nextInt();
        scanner.close();
        System.out.println((studentGrade > 0) & (studentGrade <= 5) ? "The grade is correct" : "The grade is incorrect");
     ...
     * текстовое сообщение.
     */
    public static void EightOneThree() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Please enter a two-digit positive number");
        int positiveTwoDigitNumber = scanner.nextInt();
        scanner.close();
        System.out.println((positiveTwoDigitNumber / 10) == (positiveTwoDigitNumber % 10) ? "The number consists of the same digits"
                : "The number consists of different digits");
    }
     ...
     */
    public static void EightOneFour() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Please enter a two-digit positive number");
        int positiveTwoDigitNumber = scanner.nextInt();
        scanner.close();
        System.out.println((positiveTwoDigitNumber / 10) > (positiveTwoDigitNumber % 10)
                ? "The digit denoting tens is greater than the digit denoting units"
                : "A digit denoting tens, no more than a digit denoting units");
    }
     ...
     */
    public static void EightOneFive() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Please enter a two-digit positive number");
        int positiveTwoDigitNumber = scanner.nextInt();
        scanner.close();
     ...
     * текстовое сообщение.
     */
    public static void EightOneSix() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Please enter a three-digit positive number");
        int positiveThreeDigitNumber = scanner.nextInt();
        scanner.close();
        System.out.println((positiveThreeDigitNumber / 100) == (positiveThreeDigitNumber % 10) ? "symmetric number"
     ...
     * оператора if- без составного условия (незнаю такого решения)
     */
    public static void EightOneSeven() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Please enter a three-digit positive number");
        int number = scanner.nextInt();
        Boolean evenNumber = (number == ((number / 2) * 2));
        int sum = ((number / 100) + (number % 10) + ((number % 100) / 10));
        Boolean sumDigit = ((sum / 2) == ((sum / 2) * 2));
        System.out.println(evenNumber & sumDigit ? "Double even number" : "");
    }
